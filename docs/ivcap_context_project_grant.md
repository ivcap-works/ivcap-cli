...
```
ivcap context project grant project_id (--user <urn> | --service <urn>) --capability <cap> ... [flags]
```

### Options

```
  -c, --capability strings   Capability to grant (repeatable). Run 'ivcap context capabilities --kind project' to list valid values
