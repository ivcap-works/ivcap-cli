...
```
ivcap context project invite project_id --email <email> [--capability <cap> ...] [flags]
```

### Options

```
  -c, --capability strings   Capability to grant on accept (repeatable). Run 'ivcap context capabilities --kind project' to list valid values
