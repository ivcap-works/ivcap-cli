...
```
ivcap context account grant account_id --user <urn> --capability <cap> ... [flags]
```

### Options

```
  -c, --capability strings   Capability to grant (repeatable). Run 'ivcap context capabilities --kind account' to list valid values
